...
export function About() {
  return (
    <Section
      ...
      title={
        <>
          A developer who cares about <span className="text-gradient-accent">the details.</span>
        </>
      }
    >
      <div className="grid lg:grid-cols-5 gap-10 items-start">
        ...
        >
          <p>
            I’m a full-stack developer who focuses on building clean, fast, and scalable web
            applications. I work across the entire stack, with a strong preference for React and
            TypeScript on the frontend and modern backend technologies on the server side. I care
            about writing maintainable code, creating smooth user experiences, and building products
          ...
          <p>
            ...
            and experimenting with new web technologies. I also enjoy improving my projects,
            learning better ways to build interfaces, and occasionally contributing to open-source
            work.
          </p>
        </motion.div>
        ...
        >
          {stats.map((s) => (
            ...
            >
              <div className="font-display text-4xl font-bold text-gradient-accent">{s.value}</div>
